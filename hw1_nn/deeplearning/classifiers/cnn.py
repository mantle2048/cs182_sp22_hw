...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        ############################################################################
        # TODO/Done: Initialize weights and biases for the three-layer convolutional    #
    ...
    def loss(self, X, y=None):
        ...
        scores = None
        ############################################################################
        # TODO/Done: Implement the forward pass for the three-layer convolutional net,  #
        ...
        loss, grads = 0, {}
        ############################################################################
        # TODO/Done: Implement the backward pass for the three-layer convolutional net, #
        ...
        dout, grads['W3'], grads['b3'] = affine_backward(dL, cache3)
